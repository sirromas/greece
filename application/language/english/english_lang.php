...
$lang['email_template_clients_fields_heading']  = 'Contacts';
...
$lang['report_sales_type_customer']                    = 'Contact Report';
...
$lang['settings_group_clients']       = 'Contacts';
$lang['settings_group_newsfeed']      = 'News feed';
$lang['settings_group_cronjob']       = 'Cron Job';
$lang['settings_yes']                                        = 'Yes';
$lang['settings_no']                                         = 'No';
$lang['settings_clients_default_theme']                      = 'Default contacts theme';
$lang['settings_clients_allow_registration']                 = 'Allow contacts to register';
...
$lang['survey_add_edit_only_for_logged_in']        = 'Only for logged in participants (staff,contacts)';
$lang['send_survey_string']                        = 'Send Survey';
$lang['survey_send_mail_list_clients']             = 'Contacts';
...
$lang['lead_email_already_exists']                = 'Lead email already exists in contacts data';
$lang['lead_to_client_base_converted_success']    = 'Lead converted to contact successfully';
$lang['lead_have_client_profile']                 = 'This lead have contact profile.';
$lang['lead_converted_edit_client_profile']       = 'Edit Profile';

# Invoices
$lang['view_invoice_as_customer_tooltip']                                     = 'View invoice as contact';
...
# Settings
$lang['settings_allow_payment_amount_to_be_modified']               = 'Allow contact to modify the amount to pay (for online payments)';
...
$lang['settings_rtl_support_client']                                  = 'RTL Contacts Area (Right to Left)';
...
$lang['customers_summary']                 = 'Contacts Summary';
...
$lang['goal_type_increase_customers_without_leads_conversions']         = 'Increase Contact Number';
$lang['goal_type_increase_customers_without_leads_conversions_subtext'] = 'Leads Conversion is Excluded';
$lang['goal_type_increase_customers_with_leads_conversions']         = 'Increase Contact Number';
...
$lang['expense_recurring_send_custom_on_renew']                      = 'Send the invoice to contact email when expense re-created';
...
$lang['custom_field_customers']                                      = 'Contacts';
...
$lang['get_shipping_from_customer_profile'] = 'Get shipping details from contact profile';
...
$lang['setup_google_api_key_customer_map']                     = 'Setup google api key in order to view to contact map';
...
$lang['show_customer_reminders_on_calendar'] = 'Contact Reminders';
...
$lang['import_customers']            = 'Import Contacts';
...
$lang['set_reminder_tooltip']           = 'This option allows you to never forget anything about your contacts.';
...
# Estimates
$lang['view_estimate_as_client']         = 'View estimate as contact';
...
$lang['proposal_convert_to_lead_disabled_help'] = 'You need to convert the lead to contact in order to create %s';
$lang['proposal_convert_not_related_help']      = 'The proposal needs to be related to contact in order to convert to %s';
...
# Reports
$lang['report_by_customer_groups'] = 'Total Value By Contact Regions';
...
$lang['not_invoice_sent_to_customer'] = 'Invoice Sent to Contact: %s';
...
$lang['not_lead_activity_converted_email'] = 'Lead email changed. First lead email was: %s and added as contact with email %s';
$lang['not_lead_activity_converted'] = '%s Converted this lead to contact';
...
$lang['not_proposal_comment_from_client'] = 'New comment from contact on proposal %s ...';
...
$lang['estimate_activity_client_accepted_and_converted'] = 'Contact accepted this estimate. Estimate is converted to invoice with number %s';
$lang['estimate_activity_client_accepted'] = 'Contact accepted this estimate';
...
$lang['invoice_activity_sent_to_client_cron'] = 'Invoice sent to contact by CRON';
$lang['invoice_activity_sent_to_client'] = 'sent invoice to contact';
...
$lang['settings_client_staff_add_edit_delete_task_comments_first_hour'] = 'Allow contact/staff to add/edit task comments only in the first hour (administrators not applied)';
...
$lang['customer_from_lead'] = 'Contact from %s';
...
$lang['project_view_as_client'] = 'View project as contact';
...
$lang['project_file_visible_to_customer'] = 'Visible to Contactr';
...
$lang['project_allow_client_to'] = 'Allow contact to %s';
...
$lang['project_discussion_show_to_customer'] = 'Visible to Contact';
...
$lang['no_primary_contact'] = 'This contact does have primary contact. You need to setup primary contact login as customer. Its recommended all customers to have primary contacts.';
$lang['leads_merge_customer'] = 'Contact fields merging';
...
$lang['contract_sent_to_client_success'] = 'The contract is successfully sent to the contact';
...
$lang['total_clients_deleted'] = 'Total contacts deleted: %s';
...
$lang['notification_when_customer_pay_invoice'] = 'Receive notification when contact pay invoice (built-in)';
...
$lang['allow_customer_to_change_ticket_status']= 'Allow customer to change ticket status from contacts area';
...
$lang['lead_lock_after_convert_to_customer']= 'Do not allow editing the lead after converting to contact (administrators not applied)';
...
$lang['customer_admins'] = 'Contact Admins';
$lang['assign_admin'] = 'Assign admin';
$lang['customer_admin_date_assigned'] = 'Date Assigned';
$lang['customer_admin_login_as_client_message'] = 'Hello %s. You are added as admin to this contact.';
...
# Version 1.1.9
$lang['use_recaptcha_customers_area'] = 'Allow recaptcha on contacts area (Login/Register)';
...
$lang['swap_pdf_info'] = 'Swap Company/Customer Details (company details to right side, contact details to left side)';
...
$lang['show_to_customer'] = 'Show to contact';
$lang['hide_from_customer'] = 'Hide from contact';
...
$lang['description_visible_to_customer'] = 'Show description to contact';
...
$lang['custom_field_disallow_customer_to_edit'] = 'Disallow contact to edit this field';
...
$lang['do_not_send_invoice_payment_email_template_contact'] = 'Do not send invoice payment recorded email to contact contacts';
...
$lang['customer_shipping_address_notice'] = 'Do not fill shipping address information if you won\'t use shipping address on contact invoices';
...
$lang['exclude_invoices_draft_from_client_area'] = 'Exclude invoices with draft status from contacts area';
$lang['invoice_draft_status_info'] = 'This invoice is with status Draft, status will be auto changed when you send the invoice to the contact or mark as sent.';
...
$lang['customer_currency_change_notice'] =  'If the contact use other currency then the base currency make sure you select the appropriate currency for this customer. Changing the currency is not possible after transactions are recorded.';
...
$lang['sending_email_contact_permissions_warning'] =  'Failed to auto select contact contacts. Please make sure that the customer have associated contacts with permission %s';
...
$lang['auto_assign_customer_admin_after_lead_convert'] = 'Auto assign as admin to contact after convert';
$lang['auto_assign_customer_admin_after_lead_convert_help'] = 'If this option is set to YES the staff member that converted lead to contact will be auto assigned as contact admin. NOTE: This option will apply only on staff members that do not have permission for contacts VIEW';
...
$lang['customer_attachments_show_in_customers_area'] = 'Show to contact area';
$lang['customer_attachments_show_notice'] = 'Only files uploaded from contact profile have ability to show/hide in contacts area.';
$lang['customer_profile_files'] = 'Files';
$lang['no_files_found'] = 'No Files Found';
$lang['survey_customers_all'] = 'All Contacts';
...
$lang['customer_inactive_message'] = 'This is inactive contact profile and some features may be disabled';
$lang['active_customers'] = 'Active Contactss';
$lang['inactive_active_customers'] = 'Inactive Contactss';
...
$lang['permission_customers_based_on_admins'] = 'Based on contact admins';
...
$lang['allow_contact_to_delete_files'] = 'Allow contacts to delete own files uploaded from contacts area';
$lang['file'] = 'File';
$lang['customer_contact_person_only_one_allowed'] = 'Only 1 contact is allowed when the company field is not filled. The system will cast this contact as person';
...
$lang['only_own_files_contacts'] = 'Contacts see only own files uploaded in contact area (files uploaded in contact profile)';
$lang['only_own_files_contacts_help'] = 'If you share the file manually from contact profile to other contacts they wil be able to see the file.';
...
$lang['staff_members_open_tickets_to_all_contacts_help'] = 'If staff member don\'t have permission for contacts VIEW only will be able to create new tickets from admin area to contact contacts where is assigned as contact admin.';
...
$lang['no_vault_entries'] = 'Vault entries not found for this contact.';
$lang['vault_entry_created_from'] = 'This vault entry is created by %s';
$lang['vault_entry_last_update'] = 'Last updated by %s';
$lang['vault_entry_visible_to_all'] = 'Visible to all staff member who have access to this contact';
...
$lang['exclude_proposal_from_client_area_with_draft_status'] = 'Exclude proposals with draft status from contacts area';
...
$lang['customer_statement_for'] = 'Contact Statement For %s';
...
$lang['project_shared_vault_entry_login_details'] = 'View Contact Site Login Details';
...
$lang['project_marked_as_finished_to_contacts'] = 'Send <b>Project Marked as Finished</b> email to contact contacts';
...
$lang['customer_info_format'] = 'Contact Information Format (PDF and HTML)';
...
$lang['transfer_lead_notes_to_customer'] = 'Transfer lead notes to contact profile';
...
$lang['custom_field_pdf_html_help'] = 'Make sure you check ' . $lang['custom_field_show_on_client_portal'] . ' field if you want the custom fields to be visible to contacts area and when contact download PDF or receive PDF via email.';
$lang['auto'] = 'Auto';
...
$lang['reccuring_invoice_option_gen_and_send'] = 'Generate and Autosend the renewed invoice to the contact';
...
# Version 1.9.5
$lang['customers_assigned_to_me'] = 'contacts assigned to me';
...
$lang['credit_note_send_to_client_modal_heading'] = 'Send Credit Note To Contact';
...
$lang['credit_note_no_invoices_available'] = 'There are no available invoices for this contact.';
