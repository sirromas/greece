...
define('APP_BASE_URL','http://giorgosant.com/geocrm/');
...
define('APP_ENC_KEY','69fca8b5175fcb28c089ef76c59d2359');
...
define('APP_DB_USERNAME','ant_giorg_17_crm');
/* The password used to connect to the database */
define('APP_DB_PASSWORD','oxA5?1k5');
/* The name of the database you want to connect to */
define('APP_DB_NAME','ant_giorg_17_crm');
